...
public abstract class AppDatabase extends RoomDatabase {
    ...
    public static class PopulateDbAsync extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(final Void... params) {
            ...
            achievement achievement1 = new achievement( 5);
            achievement achievement2 = new achievement(50);
            achievement achievement3 = new achievement(100);
            achievement achievement4 = new achievement(200);
            achievement achievement5 = new achievement(400);
            achievement achievement6 = new achievement(650);
            achievement achievement7 = new achievement(950);
            achievement achievement8 = new achievement(1300);
            achievement achievement9 = new achievement(1650);
            achievement achievement10 = new achievement(2050);
            achievement achievement11= new achievement(2500);
            achievement achievement12 = new achievement(3000);
            achievement achievement13 = new achievement(3550);
            achievement achievement14 = new achievement(4150);
            achievement achievement15= new achievement(4700);
            achievement achievement16 = new achievement(5550);
            achievement achievement17 = new achievement(6450);
            achievement achievement18 = new achievement(7400);
            achievement achievement19= new achievement(8400);
            achievement achievement20 = new achievement(9450);
            achievement achievement21 = new achievement(10500);
            achievement achievement22 = new achievement(11600);
